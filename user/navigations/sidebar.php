...
<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="<?= (isset($_SESSION['active_page']) && in_array($_SESSION['active_page'], ['supply', 'purchase', 'inventory', 'withdrawal-form', 'withdrawal'])) ? 'active' : ''; ?>">
                ...
                <ul class="nav nav-second-level <?= (isset($_SESSION['active_page']) && in_array($_SESSION['active_page'], ['supply', 'inventory', 'withdrawal'])) ? 'collapse in' : 'collapse'; ?>">
                    <li class="<?= (isset($_SESSION['active_page']) && $_SESSION['active_page'] == 'withdrawal-form') ? 'active' : ''; ?>"><a href="withdrawal-form.php">New Withdrawal</a></li>
