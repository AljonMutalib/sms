            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-2 d-flex justify-content-center align-items-center">
                    <div class="text-center">
                        <a data-toggle="modal" class="btn btn-outline btn-success" href="#supply-modal-form"><i class="fa fa-cart-plus"></i></a>
                    </div>
                </div>
            </div>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td align='center'><h5>" . htmlspecialchars($row['baseline']) . "</h5></td>";
                                                    echo "<td><h5><span class='label ".$color."'>" . htmlspecialchars($remark) . "</span/</h5></td>";
                                                    echo '<td>
                                                            <form action="supply-details.php" method="POST" style="display:inline;">
                                                            ...
                                                            <a href="#edit-supply-modal-form" class="btn btn-outline btn-warning" data-toggle="modal" onclick="loadSupply('.$row['ID'].')"><i class="fa fa-edit"></i></a>
                                                         </td>';
                                                    echo "</tr>";
                                                }
                                            ?>
