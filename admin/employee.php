...
<head>
    ...
    <title>DICT Region IX and BASULTA - Employees</title>
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example" >
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $sql = "SELECT ID, username, fname, mname, lname, position, province, division, employment, date_created FROM tbl_employees";
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td>" . $count++ . "</td>";
                                                    echo "<td><h5>" . htmlspecialchars($row['username']) . "</h5></td>";
                                                    echo "<td><h5>" . htmlspecialchars($row['fname']) . " " . htmlspecialchars($row['mname']) . " " . htmlspecialchars($row['lname']) . "</h5></td>";
                                                    echo "<td><h5>" . htmlspecialchars($row['position']) . "</h5></td>";
                                                    echo "<td><h6>" . htmlspecialchars($row['employment']) . "</h6></td>";
                                                    echo "<td><h6>" . htmlspecialchars($row['province']) . "</h6></td>";
                                                    echo "<td><h6>" . htmlspecialchars($row['division']) . "</h6></td>";
                                                    echo "<td><h6>" . htmlspecialchars($row['date_created']) . "</h6></td>";
                                                    echo '<td>
